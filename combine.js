...
var getMyDataFunction2 = function(stream) {
    return function() {
        var xvalue = null;
        var label = null;
        var yvalue = null;
...
function sendData2(token, refreshRate) {
    var plotly = require('plotly')(myUser, myApi);
    var data = {
        'x': [] // empty arrays since we will be streaming our data to into these arrays
            ,
    ...
    plotly.plot(data, layout, function(err, msg) {
        ...
        // Loop forever
        setInterval(getMyDataFunction2(myStream), refreshRate);
    });
};

sendData2(myToken2, refresh);
